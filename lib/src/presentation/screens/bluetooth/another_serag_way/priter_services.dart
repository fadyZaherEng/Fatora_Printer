...
import 'package:fatora/src/presentation/screens/bluetooth/another_serag_way/printer_widgets.dart';
import 'package:flutter/material.dart';
import 'package:flutter/rendering.dart';
import 'package:flutter/services.dart';
import 'package:image/image.dart' as AnotherImage;

GlobalKey<NavigatorState> appNavigatorKeySerag = GlobalKey<NavigatorState>();
...
Future<Uint8List?> createImageFromWidget(Widget widget, {Duration? wait, Size? logicalSize, Size? imageSize}) async {
  ...
  var cxt = appNavigatorKeySerag.currentState!.context;
